                    ...
                    {friends.map(friend => (
                        <Link to={"/profile/" + friend.username}
                            ...
                            <div className="rightbarFollowing">
                                <img
                                    src={friend.profilePicture ? PF + friend.profilePicture : PF + "person/no-avatar.png"}
                                    alt=""
                                    className="rightbarFollowingImg"
                                />
                                <span className="rightbarFollowingName" style={{ textAlign: 'center' }}>{friend.username}</span>
                            </div>
                        </Link>
                    ))}
